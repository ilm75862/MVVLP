...
from avp_env.agents.LLM_agent import QwenVLAgent, JanusAgent, Qwen3VLInstructAgent,Qwen3VLThinkingAgent
import argparse
import os
import gc
import torch
...
if __name__ == "__main__":
    ...
    parser.add_argument('--models', nargs='+', type=str, default=['Qwen3-VL-8B-Instruct'], help='Name of model')
    ...
    for model in args.models:
        for instr_type in args.instr_types:
            for view in args.views:
                ...
                if model == 'Qwen3-VL-8B-Think':
                    agent = Qwen3VLThinkingAgent()
                elif model == 'Qwen2.5-VL-7B-Instruct':
                    agent = QwenVLAgent()
                elif model == 'Qwen3-VL-8B-Instruct':
                    agent = Qwen3VLInstructAgent()
